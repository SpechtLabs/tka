<template>
  <div v-if="hasContributors">
    ...
    <p class="description">
      Your contributions matter. Here's to everyone who's helped bring this to
      life.
    </p>
    <div class="contributors-list">
      ...
      >
        <img
          ...
          height="80"
        />
        <a class="contributor__name" :href="contributor.html_url"
          >{{ contributor.login }} <OutboundLink
        /></a>
      </div>
    </div>
  </div>
